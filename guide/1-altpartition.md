...
```cmd
/data/data/com.termux/files/usr/bin/mkfs.ntfs -f /dev/block/sda33 -L WINCEPHEUS
``` 
```cmd
/data/data/com.termux/files/usr/bin/mkfs.fat -F32 -s1 /dev/block/sda32 -n ESPCEPHEUS
``` 
